...
(async () => {
  ...
  console.log('PASS: persistent reload, owner filtering, project ownership, PMID/DOI duplicates, note upserts, Crossref notes, import merge, failed writes, cascading removal and concurrent DOI saves.');
