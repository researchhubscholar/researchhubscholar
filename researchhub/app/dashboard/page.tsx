...
const tools = [
  ...
  { href: "/orientacao", tag: "05 · Revisar", title: "Trabalhe com o orientador", text: "Compartilhe um projeto, organize comentários, reuniões, pendências e versões." },
];
